    ...
    model {
        ...
        icegate = softwareSystem "IceGate" "Observability data lake engine storing logs, traces, metrics, and events in Apache Iceberg" {
            ...
            maintainService = container "Maintain Service" "Schema migrations and data maintenance" "Rust / CLI" {
                ...
                shifter = component "Queue Shifter" "Background task that combine segments to write to Iceberg" "Rust"
            }
        ...
        icegate.maintainService.shifter -> icegate.queueLib.queueReader "Reads queue segments" "Rust API"
        icegate.maintainService.shifter -> icegate.icebergStorage "Writes Iceberg data" "S3"
        icegate.maintainService.shifter -> icegate.catalogStore "Commits snapshots" "REST"
    }
