...
description: API HTTP compatible Tempo servie par {{product_name}} - endpoints de recherche et de récupération de traces, authentification, état d'avancement et modèle de spans.
---
