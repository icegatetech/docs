...
description: Как {{product_name}} разделяет вычисления и хранение - принципы проектирования, диаграммы системы и контейнеров, компоненты, стек технологий и масштабирование.
---
...
Поэтому срок жизни объектов - это параметр надёжности, а не просто уборка: сегмент обязан пережить коммит, который его покрывает. Если в момент срабатывания правила shift задержан или падает, сегменты с незафиксированными офсетами будут удалены, а данные потеряны. О выборе срока см. [Хранение Данных](../guides/data-retention.md).
