---
title: Сборка
description: Соберите {{product_name}} из исходников - установка Rust, клонирование репозитория, профили сборки, шесть крейтов воркспейса, запуск сервисов и тестов.
---
