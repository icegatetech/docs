...
description: Как участвовать в разработке {{product_name}} - настройка окружения, стиль кода, структура проекта, правила pull request, тесты, документация и релизы.
---
