...
description: Настройка локального окружения для разработки IceGate
---

# Окружение для Разработки

Это руководство описывает настройку локального окружения для разработки IceGate: написания кода, запуска тестов и отладки.
...
**Пространство имён IceGate (`icegate`):**
...
| Grafana | Дашборды с готовыми панелями IceGate Ingest и Query |
| Jaeger | Распределённая трассировка для сервисов IceGate |
