---
title: Установка
description: Установите {{product_name}} в Kubernetes через Helm chart или оверлеи Kustomize - требования, варианты каталога и хранилища, проверка развёртывания.
---
