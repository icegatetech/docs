---
title: Быстрый Старт
description: Загрузите первые логи, трейсы и метрики в {{product_name}}, выполните запросы на LogQL и подключите Grafana и OpenTelemetry Collector за несколько минут.
---
