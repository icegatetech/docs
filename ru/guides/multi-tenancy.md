...
description: Изолируйте тенантов в {{product_name}} - определение тенанта, гарантии изоляции данных, настройка Grafana, пример с тремя тенантами и лучшие практики.
---
...
{{product_name}} разработан как мультитенантная система, обеспечивающая изоляцию данных между разными организациями или командами.
