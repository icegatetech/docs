...
description: Запросы к {{product_name}} на LogQL - работа с данными в реальном времени через WAL, статус реализации, разобранные примеры и прямые вызовы HTTP API.
---

# Запросы к Данным

{{product_name}} предоставляет API, совместимые с Loki и Tempo, для запросов к данным наблюдаемости, а также
Arrow Flight SQL для универсального SQL. [API, совместимый с Prometheus](../api-reference/prometheus.md),
