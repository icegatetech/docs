---
title: Обслуживание
description: Поддерживайте {{product_name}} в рабочем состоянии - миграции схемы, компакция Shift, оптимизация таблиц, ротация данных, мониторинг и резервное копирование.
---
